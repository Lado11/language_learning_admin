                ...
                <div className="wordExelAdd ">
                    <div className="addWordExel">
                        <div>
                            ...
                            <CustomAsyncPaginate style={customStyles} onChange={onChange} 
                            current={current} placeholder="English" loadOptions={handleLoadOptions} />
                        ...
                        <div className="learnLanguageSelectedLanguages">
                            ...
                            <SelectLearningLang  loadOptions={handleLoadOptionsNative} current={current} name={"Native Language"} rules={true} dataLanguages={languages} onDelete={(id) => {
